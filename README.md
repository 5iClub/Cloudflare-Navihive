...
[📖 完整文档](https://5iClub.github.io/Cloudflare-Navihive/) • [🎮 在线演示](https://navihive.chatbot.cab/) • [🚀 快速开始](https://5iClub.github.io/Cloudflare-Navihive/deployment/) • [💬 问题反馈](https://github.com/5iClub/Cloudflare-Navihive/issues)

</div>

> 部署过程中遇到问题，暂时可参阅 V1.1.0版本[部署教程](https://github.com/5iClub/Cloudflare-Navihive/tree/v1.1.0)暂时我可能没有那么多时间来修正文档的问题，实在抱歉。
...
4. **配置数据库** → 按照[部署指南](https://5iClub.github.io/Cloudflare-Navihive/deployment/)创建 D1 数据库

> 详细步骤见[完整部署指南](https://5iClub.github.io/Cloudflare-Navihive/deployment/)
...
### 📚 用户指南
- [**项目介绍**](https://5iClub.github.io/Cloudflare-Navihive/introduction) - 了解 NaviHive 的特点和优势
- [**为什么选择 NaviHive**](https://5iClub.github.io/Cloudflare-Navihive/guide/why-navihive) - 与其他方案的对比
- [**功能截图**](https://5iClub.github.io/Cloudflare-Navihive/guide/screenshots) - 11 张精美功能截图展示
- [**常见问题**](https://5iClub.github.io/Cloudflare-Navihive/guide/faq) - FAQ 和故障排除
- [**更新日志**](https://5iClub.github.io/Cloudflare-Navihive/guide/changelog) - 版本历史和变更记录

### 🔧 开发者文档
- [**部署指南**](https://5iClub.github.io/Cloudflare-Navihive/deployment/) - 详细的部署步骤
- [**架构设计**](https://5iClub.github.io/Cloudflare-Navihive/architecture/) - 技术栈和系统架构
- [**API 文档**](https://5iClub.github.io/Cloudflare-Navihive/api/) - RESTful API 参考
- [**安全指南**](https://5iClub.github.io/Cloudflare-Navihive/security/) - 14+ 安全加固说明
- [**贡献指南**](https://5iClub.github.io/Cloudflare-Navihive/contributing/) - 如何参与项目

### 🎯 功能特性
- [**功能概览**](https://5iClub.github.io/Cloudflare-Navihive/features/) - 完整功能列表和说明

> 📝 访问 [NaviHive 文档站点](https://5iClub.github.io/Cloudflare-Navihive/) 查看完整文档
...
欢迎所有形式的贡献！查看 [贡献指南](https://5iClub.github.io/Cloudflare-Navihive/contributing/) 了解如何参与项目。
...
[立即部署](https://deploy.workers.cloudflare.com/?url=https://github.com/5iClub/Cloudflare-Navihive) • [在线演示](https://navihive.chatbot.cab/) • [完整文档](https://5iClub.github.io/Cloudflare-Navihive/) • [提交问题](https://github.com/5iClub/Cloudflare-Navihive/issues)
